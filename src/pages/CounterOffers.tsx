...
function CounterOffers() {
    ...
    useEffect(() => {
        ...
        const filteredAdmin = products.filter((product) => product.product_status === 'Counter Offer')
        const filteredUser = products.filter((product) => product.product_status === 'Counter Offer' && product.userId === loggedInUser[0].id )
  ...
  return (
    <div>
        <h1 className='text-slate-800 text-center text-2xl mt-10 mb-10'>Approved Products</h1>
